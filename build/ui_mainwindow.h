...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        ileczasu = new QLabel(horizontalLayoutWidget_2);
        ileczasu->setObjectName(QStringLiteral("ileczasu"));

        horizontalLayout_2->addWidget(ileczasu);

        licznik = new QLCDNumber(horizontalLayoutWidget_2);
        licznik->setObjectName(QStringLiteral("licznik"));

        horizontalLayout_2->addWidget(licznik);
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Linux edu exam", 0));
        ...
        ileczasu->setText(QApplication::translate("MainWindow", "Pozosta\305\202o minut:", 0));
